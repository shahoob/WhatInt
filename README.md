# `WhatInt` ![GitHub release (latest by date including pre-releases)](https://img.shields.io/github/v/release/shahoob/WhatInt?include_prereleases&label=%20&logo=python&logoColor=white&style=flat-square)
